<template>
    <div class="flex justify-between items-center mb-6 pt-6 pl-6 mx-auto">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900">Thêm danh mục mới</h1>
            <p class="text-gray-600">Điền thông tin để tạo danh mục mới</p>
        </div>
    </div>
    <div class="bg-white p-10 w-[50%] mx-auto rounded-[10px] border border-gray-300">
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-primary cursor-pointer"
                ...
                <div class="flex flex-col items-center">
                    ...
                    <p class="mt-2 text-gray-600">Click để tải ảnh lên</p>
